    ...
    <body style="background-color: #e8e8e8;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <br><br><center>
        <form role="form" method="post" action='<?php echo base_url();?>quiz_controller/reset'>
            <div class="form-inline">
            <div class="form-group">
                <label for="usr">New Password:</label>
                <input type="text" class="form-control" id="resetpass" name="resetpass" required>
            </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
            <br><br>
            <div class="alert alert-danger">
                <strong>Danger!</strong> Password of all contestant will be <b>reset</b>.
            </div><br><br>
