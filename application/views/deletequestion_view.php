...
<html>
    <head>
        ...
        function showQues(str) {
            ...
            $.ajax({
               url:window.location.protocol + "//" + window.location.hostname + "/quiz/quiz_controller/deleteques_view",
               data: data,
               type: "post",
    ...
    <br><center>
        ...
        <div  id="txtHint" class="">
           <div class="alert alert-info col-md-6 col-md-offset-3">
               <center><strong>Info!</strong> Question will be listed here with <b>delete</b> link.</center>
           </div>
       </div>
