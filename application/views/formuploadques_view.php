    ...
    <body style="background-color: #e8e8e8;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <center><br><br>
                        <form action="<?php echo base_url();?>quiz_controller/do_uploadques" method="post" enctype="multipart/form-data">
                        ...
                        <div class="alert alert-warning">
                            <strong>Warning!</strong> File name should be <b>uploadques.xls</b> and only <b>excel</b> sheet should be upload.
                        </div>
                        <br><br>
                        <div class="form-group">
